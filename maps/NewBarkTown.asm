...
NewBarkTown_MapEvents:
	...
	warp_event  3, 11, PLAYERS_NEIGHBORS_HOUSE, 1 ; Using this as a way to access other parts of the game easily. Will later revert back to PLAYERS_NEIGHBORS_HOUSE
