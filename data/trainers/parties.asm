...
Rival1Group:
	...
	db 38, CROBAT,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 37, MAGNETON,   THUNDERSHOCK, SONICBOOM, THUNDER_WAVE, SWIFT
	db 37, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 37, ALAKAZAM,   DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
